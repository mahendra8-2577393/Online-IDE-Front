...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-around md:justify-between md:px-[100px] my-[40px]">
        <h2 className="text-2xl mb-2">
          Hi, {userData ? userData.username : ""} 👋
        </h2>
        <div className="flex items-center gap-1">
          {/* Search Bar */}
          <div className="inputBox w-[200px] md:w-[350px]">
            <input
              type="text"
      ...
      <div className="cards">
        {isGridLayout ? (
          <div className="grid w-[100vw] px-[80px] md:px-[100px]">
          ...
          <div className="list px-[50px] md:px-[100px]">
            {filteredData.length > 0 ? (
              filteredData.map((item, index) => (
      ...
      {isCreateModelShow && (
        <div className="createModelCon fixed top-0 left-0 right-0 bottom-0 w-screen h-screen bg-[rgb(0,0,0,0.1)] flex items-center justify-center">
          <div className="createModel w-[90vw] h-[30vh] md:w-[25vw] md:h-[27vh] shadow-lg shadow-black/50 bg-[#141414] rounded-[10px] p-[20px]">
